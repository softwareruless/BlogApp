...
using BlogApp.Utilities.TokenHelper;
...
namespace BlogApp.Service
{
    public class LoginService : ILoginService
    {
        ...
        public LoginService(BlogAppDbContext context, UserManager<User> userManager, SignInManager<User> signInManager, RoleManager<Role> roleManager, IConfiguration configuration)
        {
            _context = context;
